...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateFieldDropdown(fieldsData) {
      console.log('Populating dropdown with:', fieldsData);
      ...
      console.log('Dropdown populated with unique fields:', addedOptions.size);
  }
        ...
        try {
            switch (operator) {
                ...
                case 'numericLessThan':
                    ...
                    statement = `<# <Conditional Test="number(${field}) ${numericOperator} ${value}" /> #>`;
                    break;
                default:
